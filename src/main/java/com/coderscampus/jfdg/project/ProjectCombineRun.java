...
public class ProjectCombineRun {
    public void  go(){
    	GenMeta introGenMeta = new GenMeta("project_intro");
        StringWriter stringWriter = new ProjectIntroGen(introGenMeta).generate(null);
        for(int i=0;i<15;i++){
        ...
        ProjectCompleteGen projectCompleteGen = new ProjectCompleteGen(new GenMeta("projectComplete", "PROJECT.md", "../rebarium/", InternalWriteFolder.DEFAULT, Paths.get("project")));
